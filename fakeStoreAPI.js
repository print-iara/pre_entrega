...
//agregarProducto({title: 'prueba producto', price: 10.5, description: 'texto prueba', image: 'https://i.pravatar.cc', category: 'clothes'})
//eliminarProducto(2)
// actualizarProducto({id:10, title: 'prueba producto actualizado', price: 13.5, description: 'texto prueba actualizado', image: 'https://i.pravatar.cc', category: 'clothes'})
